...
(async () => {
  ...
  //    （這是同一個問題第三次過期：2026-06-24 第一次發現、2026-07-03 第二次發現並改成
  //    2026-07-02、這次 2026-07-11 是第三次發現時已經停滯超過一週，中間完整推播子系統
  //    上線〔test-rules.js 73→100、student.test.js→v20、teacher.test.js→v19〕、PWA
  //    standalone 三輪修正、saveStudentReply() 多裝置競態修正皆未反映。同一份 canary.yml
  //    的 job 名稱已經在 2026-07-10 同步成「65項+52項」，這裡卻沒有一起被想起來更新，
  //    可見光靠這段註解提醒不夠可靠，詳見 AI_測試架構說明.md 第四節陷阱17、
  //    AI_推播系統說明.md 第六節相關條目。）
  log(`對應 AI_CONTEXT.md 版本：2026-07-11`);
  log('═'.repeat(50));
