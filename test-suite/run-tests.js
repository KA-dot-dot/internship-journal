...
(async () => {
  ...
  //    （這是同一個問題第六次過期：2026-06-24／2026-07-03／2026-07-11／2026-07-15／
  //    2026-07-17 已發生過五次。第三次修正時試過「把當下最新版本號寫進這段註解」的做法，
  //    結果那組版本號本身也在幾天內過期，等於多製造一個要同步的地方——這次（第六次，
  //    2026-07-23，對應「換公司後薪資統計/公司篩選清單/舊月份月記公司覆蓋」修法：
  //    student.test.js v24→v25 新增 S-SEC-39、teacher.test.js v23→v24 新增
  //    T-SEC-43～46 並修正 T-SEC-40 的第二次競態）刻意不再重複這個做法，只更新日期
  //    本身。真要根治，仍建議改成執行時動態讀取 tests/*.test.js 開頭的版本注解，而不是
  //    任何形式的手動記憶，詳見 AI_測試架構說明.md 第四節陷阱17。）
  log(`對應 AI_CONTEXT.md 版本：2026-07-23`);
  log('═'.repeat(50));
