...
(async () => {
  ...
  //    （這是同一個問題第五次過期：2026-06-24／2026-07-03／2026-07-11／2026-07-15 已發生
  //    過四次。第三次修正時試過「把當下最新版本號寫進這段註解」的做法，結果那組版本號
  //    本身也在幾天內過期，等於多製造一個要同步的地方——這次（第五次，2026-07-17，對應
  //    新增的 minEntries／篇數功能：student.test.js v23→v24、teacher.test.js v22→v23）
  //    刻意不再重複這個做法，只更新日期本身。真要根治，仍建議改成執行時動態讀取
  //    tests/*.test.js 開頭的版本注解，而不是任何形式的手動記憶，詳見
  //    AI_測試架構說明.md 第四節陷阱17。）
  log(`對應 AI_CONTEXT.md 版本：2026-07-17`);
  log('═'.repeat(50));
