...
(async () => {
  ...
  //    （這是同一個問題第八次過期：2026-06-24／2026-07-03／2026-07-11／2026-07-15／
  //    2026-07-17／2026-07-23／2026-08-05 已發生過七次。第三次修正時試過「把當下最新
  //    版本號寫進這段註解」的做法，結果那組版本號本身也在幾天內過期，等於多製造一個要
  //    同步的地方——這次（第八次，2026-08-08，對應「刪除操作二次確認」補上自動化測試：
  //    student.test.js v27→v28 新增 S-SEC-43、teacher.test.js v27→v28 新增 T-SEC-49）
  //    刻意不再重複這個做法，只更新日期本身。真要根治，仍建議改成執行時動態讀取
  //    tests/*.test.js 開頭的版本注解，而不是任何形式的手動記憶，詳見
  //    AI_測試架構說明.md 第四節陷阱17。）
  log(`對應 AI_CONTEXT.md 版本：2026-08-08`);
  log('═'.repeat(50));
